                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Edicion y Consulta de Catalogos de las Categorias de Clientes</h4>
                            </div>
                            <div class="card-body"><!-- action="/guardaEvento" -->
                                <form id="agregar" class="form-horizontal">
                             	 <input type="hidden" id="catClienteId" name="catClienteId">
...
<!--                              <h6 class="card-subtitle">Lista empleados para consultar llamadas </h6> -->
                             <div class="table-responsive m-t-40">
                                 ...
                                 <table id="myTable" class="table table-bordered table-striped">
                                     ...
                                     <tbody>
						  	              <c:forEach var="catCateogriaClientes"  begin="0"  items="${lstCatCategoriaCliente}">	
											<tr>
												<td>${catCateogriaClientes.catClienteId}</td>
												<td><span class="label ${catCateogriaClientes.classLabel}">${catCateogriaClientes.descripcion}</span></td>
												
												<c:if test="${catCateogriaClientes.activo == '1' }">
										    		<td><span class="label label-success">ACTIVO</span> </td>
												</c:if>
												<c:if test="${catCateogriaClientes.activo == '0'}">
										    		<td><span class="label label-danger">INACTIVO</span> </td>
												</c:if>
												
												<td style="white-space:nowrap;" align="left">
						                            
						                            <button type="button" onclick="edita(${catCateogriaClientes.catClienteId},'${catCateogriaClientes.descripcion}',${catCateogriaClientes.activo},'${catCateogriaClientes.classLabel}')" title="Editar Evento" class="btn btn-outline-info btn-sm" >
						                            	<i class="fa fa-edit"></i>
						                            </button>
						                            <button type="button" onclick="elimina(${catCateogriaClientes.catClienteId})" title="Eliminar Evento" class="btn btn-outline-info btn-sm">
	...
	//Evento para guardar o actulizar el registro
	 $("#agregarNuevo").click(function() {
		  ...
		  $.validator.addMethod("selecs", function(value, element) {
	    	...
	    	$.ajax({
	    		url: "guardaCategoriaClientes",
	    		type: "post",
	    		data: {
	    			catClienteId:$('#catClienteId').val(),
	    			 ...
	    			 if ("ok" == data) {
		    			console.log("evento agregado con exito");
	    				 ...
	    				 Swal.fire({
	    					 position: 'center',
  	    					  type: 'success',
  	    					 title: "Operacion realizada con exito se Agrego/Actualizo una Categoria de Cliente!",
...
function elimina(catClienteId) {
	
	 Swal.fire({
		  title: 'Estas seguro esta categoria del catalogo?',
		  text: "ya no existira en las categorias de los clientes!",
		  type: 'warning',
		  ...
		  if (result.value) {
			  console.log(result.value);
			 	...
			 	$.ajax({
					url: "eliminarCategoriaCliente",
					type: "post",
					data: {
						catClienteId:catClienteId
					},	
					success : function(data){
						console.log("data--->"+data);
