...
!function($) {
    ...
    CalendarApp.prototype.init = function() {
        ...
        var defaultEvents =  [{
                ...
                title: 'Aniversario Colonia',
                start: new Date($.now() - 1099000000),
                end:  new Date($.now() - 919000000),
                className: 'bg-warning'
            },{
                title: 'Jaripeo Baile Tepetzingo',
                start: new Date($.now() - 1199000000),
                end: new Date($.now() - 1199000000),
                className: 'bg-purple'
            },{
                title: 'Junta en Cuernavaca con Presidente Municipal',
                start: new Date($.now() - 399000000),
                end: new Date($.now() - 219000000),
                className: 'bg-info'
            },  
              {
                title: 'Baile de La Morelos',
