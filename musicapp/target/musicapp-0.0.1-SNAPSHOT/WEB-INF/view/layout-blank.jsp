...
<head>
	...
	function imprimedoc() {	
        //var href = "../imprimirInsumos/impresionReportesInsumos?instrumentoId=5&causaPenalId="+causaPenalId+"&tramiteArId="+tramiteId;
        var href = "<c:url value='../main/exchangeRates'/>";
        let pdfWindow = window.open("")
         pdfWindow.open(href, '_self', 'width=600,height=750');
        //return false;
	}
	
    function imprimedoc1(){
        $.ajax({         
                    //url: urlController+"?"+parametros,
                    url: '<c:url value='../main/helloReport1'/>',		
                    type: "GET",
                    ...
                    success: function(data) { 
                    		...
                    		let pdfWindow = window.open("")
                    		pdfWindow.document.write("<iframe width='100%' height='100%' src='data:application/pdf, " + escape(data)+"'></iframe>")
	...
	function showDialogConfirm(msg){
		$("<div>" + msg + "</div>").dialog({
			...
			buttons : {
				Aceptar: function() {
	                   //jQuery("#formCedulaVerificacion").submit();
	            },
				Cancelar : function() {
					$(this).dialog("close");
				}
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
						...
						<li> <a class="has-arrow  " href="#" aria-expanded="false"><i class="fa fa-suitcase"></i><span class="hide-menu">Eventos <!--span class="label label-rouded label-danger pull-right">6</span--></span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li><a href="uc-calender.html"><i class="fa fa-calendar-check-o"></i> Calendario</a></li>
                                <li><a href="uc-datamap.html"><i class="fa fa-building"></i> Reporte</a></li>
                            </ul>
                        </li>
