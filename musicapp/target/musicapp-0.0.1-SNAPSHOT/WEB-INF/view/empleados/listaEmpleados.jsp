                	...
                	<div class="col-12">
                		<div class="card">
                			<div class="card-body">
                             ...
                             <h6 class="card-subtitle">Lista y Edicion de empleados existentes </h6>
                             <button type="button" class="btn btn-info btn-rounded m-t-10 float-right" data-toggle="modal" id="btnAgregar" data-target="#add-contact">Agregar Nuevo Empleado</button>
                                    ...
                                    <div class="modal-dialog modal-xl">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                ...
                                                <h4 class="modal-title" id="myModalLabel"> Agregar Empleado</h4> </div>
